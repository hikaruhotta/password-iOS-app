...
document.getElementById("requestNewWords").onclick = function() {    
    let requestNewWords = firebase.functions().httpsCallable('requestNewWords');
    requestNewWords().then(result => {
        console.log(result);
    });
}
